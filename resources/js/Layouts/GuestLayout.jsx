...
export default function GuestLayout({ children }) {
    return (
        <div className="flex min-h-screen flex-col items-center bg-slate-50 pt-6 sm:justify-center sm:pt-0 dark:bg-slate-900 selection:bg-teal-500 selection:text-white">
            ...
            <div className="mt-6 w-full overflow-hidden bg-white px-6 py-8 shadow-xl sm:max-w-md sm:rounded-2xl dark:bg-slate-800 border border-slate-100 dark:border-slate-700 relative">
